...
// 프로젝트 페이지 HTML에서 토큰을 자동 추출하는 함수
...
<html>
  ...
  <body>
    ...
    if (url.pathname === "/create" && request.method === "POST") {
      ...
      // R2 (프로젝트 그룹 버킷: project-groups) 에 그룹 정보 저장 (JSON 형태)
...
<html>
  ...
  <body>
    ...
    if (url.pathname.length === 9 && url.pathname.startsWith("/")) {
      ...
      let listItems = "";
      // 각 프로젝트 URL마다 프로젝트 ID 추출 후 GraphQL API 호출
